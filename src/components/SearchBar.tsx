...
export default function SearchBar({onSearch,isLoading}:Props) {
  ...
  return <div className="activity-search">
    <form onSubmit={e=>{e.preventDefault();submit(query);}}>
      <input value={query} onChange={e=>setQuery(e.target.value)} placeholder="What are you curious about? Try writing about anything showing its brain activity…" aria-label="Describe an activity" disabled={isLoading} maxLength={500}/>
